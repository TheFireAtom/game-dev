...
def start_menu(main_display):
    ...
    delay = 150
    frame_index = 0
    spritesheet_start_button = pygame.image.load(join("My-games", "Character-templater-test", "assets", "Play_button_square-Sheet.png")).convert_alpha()
    spritesheet_start_button_scaled = pygame.transform.scale_by(spritesheet_start_button, 6)
    frames_start_button = []
    ...
    while True:
        ...
        play_button = spritesheet_start_button_scaled.subsurface(0, 0, constants.BUTTON_FRAME_WIDTH, constants.BUTTON_FRAME_HEIGHT).get_frect()
        quit_button = pygame.Rect(600, 600, 100, 100)

        play_button.center = constants.BUTTON_FRAME_WIDTH / 2, constants.BUTTON_FRAME_HEIGHT / 2 - 16 # idk why I need to do those math operations here
